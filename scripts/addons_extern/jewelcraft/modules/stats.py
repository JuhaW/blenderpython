...
def stats_get():
    ...
    if props.export_m_24g:
        append('24G')
    if props.export_m_22g:
        append('22G')
    if props.export_m_18wg:
        append('18WG')
    if props.export_m_18yg:
        append('18YG')
    if props.export_m_14wg:
        append('14WG')
    if props.export_m_14yg:
        append('14YG')
    if props.export_m_ster:
        append('STER')
    if props.export_m_pd:
        append('PD')
    if props.export_m_pl:
        append('PL')
    if props.export_m_custom:
        append('CUSTOM')
