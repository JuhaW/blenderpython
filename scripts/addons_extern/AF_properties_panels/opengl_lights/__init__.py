...
class OpenGLLightsProperties(bpy.types.PropertyGroup):
    ...
    def register(cls):
        ...
        cls.edit = bpy.props.BoolProperty(name="OpenGL Edit", description="", default=False, )
...
class VIEW3D_PT_opengl_lights_panel(bpy.types.Operator):
    bl_label = 'OpenGL Lights'
    bl_idname = "view3d.gl_lights"
