...
################ FACE #######################################
            if bpy.context.mode == "POSE":
                ...
                if "gui_picker_face" in arm and arm["gui_picker_face"]:
                    ...
                    brow_ctrl_R.operator("operator.brow_ctrl_r", text="Brow_R")
                    ...
                    brow_ctrl_L.operator("operator.brow_ctrl_l", text="Brow_L")
                    ...
                    eyelid_up_R.operator("operator.eyelid_up_ctrl_r", text="Eyelid_up_R")
                    ...
                    eyelid_low_R.operator("operator.eyelid_low_ctrl_r", text="Eyelid_low_R")
                    ...
                    eyelid_up_L.operator("operator.eyelid_up_ctrl_l", text="Eyelid_up_L")
                    ...
                    eyelid_low_L.operator("operator.eyelid_low_ctrl_l", text="Eyelid_low_L")
                    ...
                    cheek_ctrl_R.operator("operator.cheek_ctrl_r", text="Cheek_R")
                    ...
                    cheek_ctrl_L.operator("operator.cheek_ctrl_l", text="Cheek_L")
                    ...
                    mouth_ctrl_row_2.operator("operator.mouth_ctrl", text="Mouth_ctrl")
                    ...
                    mouth_mstr_ctrl.operator("operator.mouth_mstr_ctrl", text="Mouth_mstr_ctrl")
                    ...
                    teeth_up.operator("operator.teeth_up", text="Teeth_up  ")
                    ...
                    teeth_low.operator("operator.teeth_low", text="Teeth_low")
                    ...
                    tongue_mstr.operator("operator.tongue_mstr", text="Tongue_mstr")
...
# Extra Properties
            if bpy.context.mode == "POSE":
                ...
                if "gui_misc" in arm and arm["gui_misc"]:
                    ...
                    # Teeth - Follow Smile
                    box.prop(props, "gui_extra_props_head", text='Head')
                ...
                # Fingers
                    ...
                    # Accessories
                    box.prop(props, "gui_extra_props_accessories", text='Accessories')
