...
bl_info = {
    ...
    "version": (1, 2),
    "blender": (2, 63, 0),
    "location": "3D View, Tool Shelf, Tools Tab, Drop To Ground",
...
class VIEW3D_PT_drop_to_ground(Panel):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("object.drop_on_active", text="Drop to Ground")
...
def unregister():
    ...
    bpy.utils.uregister_class(VIEW3D_PT_drop_to_ground)
