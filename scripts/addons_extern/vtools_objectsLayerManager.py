bl_info = {
    ...
    "warning": "",
    "description": "Simple object layer manager with no count "
...
class VTOOLS_OP_collectObjectLayers(bpy.types.Operator):
    ...
    bl_description = "collect layers from objects in scene. "
    "ie: when an object is linked or appened"
