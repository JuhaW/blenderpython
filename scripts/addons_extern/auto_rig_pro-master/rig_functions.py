...
class CamUI(bpy.types.Panel):
    bl_category = "Animation"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_label = "Auto-Rig Pro: Auto UI"
    bl_idname = "Test"
    ...
    def draw(self, context):
       ...
       # AUTO UI CAM   
        ...
        #button to enable/disable it
        layout.prop(scene, "enable_auto_ui_cam", "Auto UI Camera")
            
        if scene.enable_auto_ui_cam:
            try:
