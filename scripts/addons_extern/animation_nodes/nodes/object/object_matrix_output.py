...
class ObjectMatrixOutputNode(bpy.types.Node, AnimationNode):
    ...
    def getExecutionCode(self):
        ...
        if t == "BASIS":
            lines.append("    object.matrix_basis = matrix")
        if t == "LOCAL":
            lines.append("    object.matrix_local = matrix")
        if t == "PARENT INVERSE":
            lines.append("    object.matrix_parent_inverse = matrix")
        if t == "WORLD":
            lines.append("    object.matrix_world = matrix")
