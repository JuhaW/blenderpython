...
class Model(common.Diff):
    ...
    def __init__(self, version=2.0, name=u'空モデル', english_name=u'empty model', comment=u'pymeshioで生成', english_comment=u'created by pymeshio'
                 ):
        self.path = ''
        ...
        self.textures = []
        self.materials = [
            Material(u'マテリアル', u'material', common.RGB(0.5, 0.5, 1), 1.0, 1, common.RGB(1, 1, 1), common.RGB(0, 0, 0), 0, common.RGBA(0, 0, 0, 1), 0, -1, -1, MATERIALSPHERE_NONE, 1, 0, u"comment", 0
                     )
        ]
        self.bones = [
            Bone(u'センター', u'center', common.Vector3(), -1, 0, 0
                 )
        ]
        self.morphs = []
        self.display_slots = [
