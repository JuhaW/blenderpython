    ...
    for nowthing in things:
        if nowthing.type not in {'CAMERA', 'LAMP'}:
            ...
            for mats in nowthing.material_slots:
                    ...
                    if tex:
                        ...
                        if tex.texture.type == 'IMAGE':
                            ...
                            if tex.texture.image:
                                ...
                                if texdiffuseuse is True or texdiffusemapcol is True:
                                    bi_diffuse = 'yes'
                                    teximgrealname = tex.texture.image.name
                                ...
                                if texnormaluse is True or texdisplaceuse is True:
                                    ...
                                    bumpSlot = slotNum
                                if texnormaluse is True:
                                    if texdisplaceuse is False:
                ...
                if matuseRTmirror is True and matRTmirror > 0.9:
                    bi_mirror = 'yes'
                    bi_gloss = 'no'
                    bi_matt = 'no'
                    bi_lucent = 'no'
                ...
                if matuseRTmirror is True and matRTmirror > 0.1:
                    if matalpha >= 0.4:
                        bi_mirror = 'no'
                        bi_gloss = 'yes'
                        bi_matt = 'no'
                ...
                if nowmat.transparency_method == 'RAYTRACE':
                    ...
                    if nowmat.alpha >= 0.6 and nowmat.alpha < 0.9:
                        if bi_gloss == 'yes':
                            ...
                            bi_mlucent = 'yes'
                if nowmat.use_transparency is True and nowmat.alpha > 0.99:
