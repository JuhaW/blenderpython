...
class InsertAutoKeyframe(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if bpy.context.scene.tool_settings.use_keyframe_insert_auto is True:
            bpy.context.scene.tool_settings.use_keyframe_insert_auto = False

        if bpy.context.scene.tool_settings.use_keyframe_insert_auto is False:
...
class LockCameraTransforms(bpy.types.Operator):
    ...
    def execute(self, context):
        if bpy.context.object.lock_rotation[0] is False:
        ...
        elif bpy.context.object.lock_rotation[0] is True:
