...
classes = [
    DATA_PT_lichtwerk_meshtransfer,
    DATA_OT_lichtwerk_meshtransfer_bind,
    DATA_OT_lichtwerk_meshtransfer_unbind,
    DATA_OT_lichtwerk_meshtransfer_weights,
    DATA_OT_lichtwerk_meshtransfer_vcols,
    DATA_OT_lichtwerk_meshtransfer_shapekeys,
    DATA_OT_lichtwerk_meshtransfer_shape,
    MeshTransfer_Props
]
