...
bl_info = {
    "name": "Dynamic Context Menu Modified",
    "author": "meta-androcto",
    "version": (1, 8, 0),
    "blender": (2, 77, 0),
    "location": "View3D > Spacebar",
    "description": "Object Mode Context Sensitive Spacebar Menu Modified",
    "warning": "",
...
class VIEW3D_MT_Space_Dynamic_Menu_Pref(bpy.types.AddonPreferences):
    ...
    use_separators = bpy.props.BoolProperty(
        ...
        default=False,
        description="Use separators in the menus, a trade-off between readability vs. using more space for displaying items"
    )

    def draw(self, context):
        layout = self.layout
        layout.prop(self, "use_separators")
