...
def create_light_grid(self, context):
    ...
    obj_light = context.active_object
    if obj_light.nbcol < 1:
        obj_light.nbcol = 1
    if obj_light.nbrow < 1:
        obj_light.nbrow = 1
...
class AddLight(bpy.types.Operator):
    ...
    #---Begin Interactive
        ...
        #---Scale the light
            ...
            #---HUD
                if obj_light.typlight in ("Panel", "Pencil"):
                    if self.scale_before == 0:
                        self.scale_before = obj_light.scale[0]
                elif obj_light.typlight in ("Point", "Sun", "Spot"):
                    lamp = obj_light.data
                    if self.scale_before == 0:
                        self.scale_before = lamp.shadow_soft_size
                elif obj_light.typlight == "Sky":
                    lamp = obj_light.data
                    if self.scale_before == 0:
                        self.scale_before = lamp.shadow_soft_size
        ...
        #---Scale the light on X axis
            ...
            #---HUD
                if obj_light.typlight == "Panel":
                    if obj_light.shape == "Star":
                        if self.scale_before == 0:
                            self.scale_before = obj_light.xtrnrad
                    else:
                        if self.scale_before == 0:
                            self.scale_before = obj_light.scale[0]
                elif obj_light.typlight == "Area":
                    ...
                    lamp = obj_light.data
                    if self.scale_before == 0:
                        self.scale_before = lamp.spot_size
        ...
        #---Scale the light on Y axis
            ...
            #---HUD
                if obj_light.typlight == "Panel":
                    if obj_light.shape == "Star":
                        if self.scale_before == 0:
                            self.scale_before = obj_light.itrnrad
                    else:
                        if self.scale_before == 0:
                            self.scale_before = obj_light.scale[1]
                elif obj_light.typlight == "Area":
                    lamp = obj_light.data
                    if self.scale_before == 0:
                        self.scale_before = lamp.size_y
                elif obj_light.typlight == "Spot":
                    lamp = obj_light.data
                    if self.scale_before == 0:
                        self.scale_before = lamp.spot_blend
        ...
        #---Remove a side.
                ...
                if obj_light.shape == "Star":
                    obj_light.nbside -= 2
                    if obj_light.nbside < 12:
                        obj_light.nbside = 12
                else:
                    obj_light.nbside -= 1
                    if obj_light.nbside < 3:
                        obj_light.nbside = 3
