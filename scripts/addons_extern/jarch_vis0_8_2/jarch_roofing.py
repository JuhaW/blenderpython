...
def tin_normal(wh, ow, slope):
    ...
    while cur_x < ow:
        ...
        for i in range(4):
            ...
            v += ((cur_x + nfei, cur_y, oi + z), (cur_x + nfei, cur_y + oh, oi + z))
            cur_x += otqi
            v += ((cur_x - nfei, cur_y, oi + z), (cur_x - nfei, cur_y + oh, oi + z), (cur_x - fei, cur_y, nti + z), (cur_x - fei, cur_y + oh, nti + z))  # Right Mid Rib
            v += ((cur_x - hi, cur_y, eti + z), (cur_x - hi, cur_y + oh, eti + z), (cur_x, cur_y, z), (cur_x, cur_y + oh, z))
            cur_x += ofei

            for i in range(2):
                v += ((cur_x, cur_y, 0.0), (cur_x, cur_y + oh, 0.0), (cur_x + qi, cur_y, ei), (cur_x + qi, cur_y + oh, ei))
                cur_x += oi
                v += ((cur_x, cur_y, ei), (cur_x, cur_y + oh, ei), (cur_x + qi, cur_y, 0.0), (cur_x + qi, cur_y + oh, 0.0))
                cur_x += ohi + qi
            cur_x += ei
            for i in v:
                v2.append(i)
        ...
        v2 += ((cur_x + nfei, cur_y, oi), (cur_x + nfei, cur_y + oh, oi))
        cur_x += otqi
        v2 += ((cur_x - nfei, cur_y, oi), (cur_x - nfei, cur_y + oh, oi), (cur_x - fei, cur_y, nti), (cur_x - fei, cur_y + oh, nti))  # Right Mid Rib
...
def tin_angular(wh, ow, slope):
    ...
    while cur_x < ow:
        ...
        for i in range(3):
            ...
            v += ((cur_x + ti, cur_y, z), (cur_x + ti, cur_y + oh, z))
            cur_x += 2 * ti
            for i in range(2):
                v += ((cur_x, cur_y, 0.0), (cur_x, cur_y + oh, z), (cur_x + qi, cur_y, ei), (cur_x + qi, cur_y + oh, ei), (cur_x + ohi, cur_y, ei), (cur_x + ohi, cur_y + oh, ei))
                cur_x += ohi
                v += ((cur_x + qi, cur_y, 0.0), (cur_x + qi, cur_y + oh, 0.0))
                cur_x += qi + ti + hi
            cur_x -= hi
            for i in v:
                v2.append(i)
        ...
        v2 += ((cur_x + ti, cur_y, 0.0), (cur_x + ti, cur_y + oh, 0.0))
        vts = []
        ...
        if area.type == 'VIEW_3D':
            for space in area.spaces:
                if space.type == 'VIEW_3D':
                    if bpy.context.object.ro_is_preview == True:
