...
def EXT(PR, vr, fc, lz, mz, rz):
    ...
    if lz == 0:
        for P in PR:
            vr.append([-mz, P[0], P[1]])
    else:
        for P in PR:
            vr.append([P[0] - mz, lz, P[1]])
        for P in PR:
            vr.append([P[0] - mz, P[0], P[1]])
    if rz == 0:
        for P in PR:
            vr.append([mz, P[0], P[1]])
    else:
    ...
    for j in range(0, l):
        for i in range(0, m):
            a = j * m
            if i == m - 1:
                fc.append([a + i + n, a + 0 + n + 0, a + 0 + n + 0 + m, a + i + n + m])
            else:
                fc.append([a + i + n, a + i + n + 1, a + i + n + 1 + m, a + i + n + m])
...
def add_object(s, context):
    ...
    if h < 0:  # Pavement
        ...
        if lz > 0 and rz > 0:
            ...
            fc = [[1, 0, 2, 3], [3, 2, 4, 5], [6, 4, 2, 0], [3, 5, 7, 1], [8, 9, 11, 10]]
            Dos = [0, 1, 2, 3, 4]
    else:
    ...
    for i in range(s.lst):
        if blok[i][0] == '1':  # Balcony
            ...
            for f in range(blok[i][1][2]):
                ...
                PR.append([-k1, fz])
                PR.append([-k1 + fd, fz])
                PR.append([-k1 + fd, fz - fh])
                PR.append([-k1, fz - fh])
                fz -= fh
            BB = len(fc)
            EXT(PR, vr, fc, lz, mz, rz)
            BE = len(fc)
            for F in range(BB, BE):
                Bal.append(F)
...
# OBJE -----------------------------------------------------------
    ...
    for i in Glass:
        mesh.polygons[i].material_index = 4
    for i in Dos:
        mesh.polygons[i].material_index = 5
...
class OBJECT_OT_add_balcony(bpy.types.Operator):
    ...
    fh0 = IntProperty(min=1, max=10, default=3)
    fd0 = IntProperty(min=1, max=10, default=2)
    f00 = IntProperty(min=1, max=200, default=16)
    f01 = IntProperty(min=1, max=200, default=12)
    f02 = IntProperty(min=1, max=200, default=12)
    f03 = IntProperty(min=1, max=200, default=12)
    f04 = IntProperty(min=1, max=200, default=3)
    f05 = IntProperty(min=1, max=200, default=3)
    f06 = IntProperty(min=1, max=200, default=3)
    f07 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh1 = IntProperty(min=1, max=10, default=3)
    fd1 = IntProperty(min=1, max=10, default=2)
    f10 = IntProperty(min=1, max=200, default=3)
    f11 = IntProperty(min=1, max=200, default=3)
    f12 = IntProperty(min=1, max=200, default=3)
    f13 = IntProperty(min=1, max=200, default=3)
    f14 = IntProperty(min=1, max=200, default=3)
    f15 = IntProperty(min=1, max=200, default=3)
    f16 = IntProperty(min=1, max=200, default=3)
    f17 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh2 = IntProperty(min=1, max=10, default=3)
    fd2 = IntProperty(min=1, max=10, default=2)
    f20 = IntProperty(min=1, max=200, default=3)
    f21 = IntProperty(min=1, max=200, default=3)
    f22 = IntProperty(min=1, max=200, default=3)
    f23 = IntProperty(min=1, max=200, default=3)
    f24 = IntProperty(min=1, max=200, default=3)
    f25 = IntProperty(min=1, max=200, default=3)
    f26 = IntProperty(min=1, max=200, default=3)
    f27 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh3 = IntProperty(min=1, max=10, default=3)
    fd3 = IntProperty(min=1, max=10, default=2)
    f30 = IntProperty(min=1, max=200, default=3)
    f31 = IntProperty(min=1, max=200, default=3)
    f32 = IntProperty(min=1, max=200, default=3)
    f33 = IntProperty(min=1, max=200, default=3)
    f34 = IntProperty(min=1, max=200, default=3)
    f35 = IntProperty(min=1, max=200, default=3)
    f36 = IntProperty(min=1, max=200, default=3)
    f37 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh4 = IntProperty(min=1, max=10, default=3)
    fd4 = IntProperty(min=1, max=10, default=2)
    f40 = IntProperty(min=1, max=200, default=3)
    f41 = IntProperty(min=1, max=200, default=3)
    f42 = IntProperty(min=1, max=200, default=3)
    f43 = IntProperty(min=1, max=200, default=3)
    f44 = IntProperty(min=1, max=200, default=3)
    f45 = IntProperty(min=1, max=200, default=3)
    f46 = IntProperty(min=1, max=200, default=3)
    f47 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh5 = IntProperty(min=1, max=10, default=3)
    fd5 = IntProperty(min=1, max=10, default=2)
    f50 = IntProperty(min=1, max=200, default=3)
    f51 = IntProperty(min=1, max=200, default=3)
    f52 = IntProperty(min=1, max=200, default=3)
    f53 = IntProperty(min=1, max=200, default=3)
    f54 = IntProperty(min=1, max=200, default=3)
    f55 = IntProperty(min=1, max=200, default=3)
    f56 = IntProperty(min=1, max=200, default=3)
    f57 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh6 = IntProperty(min=1, max=10, default=3)
    fd6 = IntProperty(min=1, max=10, default=2)
    f60 = IntProperty(min=1, max=200, default=3)
    f61 = IntProperty(min=1, max=200, default=3)
    f62 = IntProperty(min=1, max=200, default=3)
    f63 = IntProperty(min=1, max=200, default=3)
    f64 = IntProperty(min=1, max=200, default=3)
    f65 = IntProperty(min=1, max=200, default=3)
    f66 = IntProperty(min=1, max=200, default=3)
    f67 = IntProperty(min=1, max=200, default=3)
    # Bulwark
    ...
    fh7 = IntProperty(min=1, max=10, default=3)
    fd7 = IntProperty(min=1, max=10, default=2)
    f70 = IntProperty(min=1, max=200, default=3)
    f71 = IntProperty(min=1, max=200, default=3)
    f72 = IntProperty(min=1, max=200, default=3)
    f73 = IntProperty(min=1, max=200, default=3)
    f74 = IntProperty(min=1, max=200, default=3)
    f75 = IntProperty(min=1, max=200, default=3)
    f76 = IntProperty(min=1, max=200, default=3)
    f77 = IntProperty(min=1, max=200, default=3)
    # Bulwark
