...
def add_object(self, context):
    ...
    vr.append([-mx - k1, 0, 0])
    vr.append([mx + k1, 0, 0])
    vr.append([mx + k1, 0, my])
    vr.append([-mx - k1, 0, my])
    vr.append([-mx, pdr, alt])
    vr.append([mx, pdr, alt])
    vr.append([mx, pdr, ust])
    vr.append([-mx, pdr, ust])
    vr.append([-mx - k1, drn, 0])
    vr.append([mx + k1, drn, 0])
    vr.append([mx + k1, drn, my])
    vr.append([-mx - k1, drn, my])
    vr.append([-mx, drn, alt])
    vr.append([mx, drn, alt])
    vr.append([mx, drn, ust])
    vr.append([-mx, drn, ust])
    fc.append([8, 0, 1, 9])
    fc.append([8, 9, 13, 12])
    fc.append([12, 13, 5, 4])
    ...
    if self.fg == 0:
        fc.append([0, 8, 11, 3])
        fc.append([8, 12, 15, 11])
        fc.append([12, 4, 7, 15])
        fc.append([5, 13, 14, 6])
        fc.append([13, 9, 10, 14])
        fc.append([9, 1, 2, 10])
    else:
        fc.append([11, 3, 16, 17])
        fc.append([15, 11, 17, 18])
        fc.append([7, 15, 18, 24])
        fc.append([25, 19, 14, 6])
        fc.append([19, 20, 10, 14])
        fc.append([20, 21, 2, 10])
        ou = self.fg * 12
        fc.append([4, 7, 12 + ou, 24 + ou])
        fc.append([6, 5, 25 + ou, 13 + ou])
    z = my
    for i in range(self.fg):
        ...
        if i == 9:
            z -= self.f9 / 100
        vr.append([-mx - k1, 0, z])
        vr.append([-mx - k1, drn, z])
        vr.append([-mx, drn, z])
        vr.append([mx, drn, z])
        vr.append([mx + k1, drn, z])
        vr.append([mx + k1, 0, z])
        vr.append([-mx - k1 + fd, 0, z])
        vr.append([-mx - k1 + fd, drn + fd, z])
        vr.append([-mx, drn + fd, z])
        vr.append([mx, drn + fd, z])
        vr.append([mx + k1 - fd, drn + fd, z])
        vr.append([mx + k1 - fd, 0, z])
        z -= fh
        ...
        vr.append([mx + k1 - fd, 0, z])
        n = len(vr)
        fc.append([n - 1, n - 2, n - 8, n - 7])
        fc.append([n - 3, n - 9, n - 8, n - 2])
        fc.append([n - 2, n - 1, n - 13, n - 14])
        fc.append([n - 3, n - 2, n - 14, n - 15])
        fc.append([n - 15, n - 14, n - 20, n - 21])
        fc.append([n - 14, n - 13, n - 19, n - 20])
        fc.append([n - 4, n - 5, n - 11, n - 10])
        fc.append([n - 5, n - 6, n - 12, n - 11])
        fc.append([n - 5, n - 4, n - 16, n - 17])
        fc.append([n - 6, n - 5, n - 17, n - 18])
        fc.append([n - 24, n - 18, n - 17, n - 23])
        fc.append([n - 23, n - 17, n - 16, n - 22])
        if self.fg > 1:
            if self.fg % 2 == 0:
                if i < self.fg / 2:
                    fc.append([7, n - 16, n - 4])
                    fc.append([6, n - 3, n - 15])
                if i + 1 < self.fg / 2:
                    fc.append([7, n - 4, n + 8])
                    fc.append([6, n + 9, n - 3])
                if i + 1 > self.fg / 2:
                    fc.append([4, n - 16, n - 4])
                    fc.append([5, n - 3, n - 15])
                if i + 1 > self.fg / 2 and i + 1 < self.fg:
                    fc.append([4, n - 4, n + 8])
                    fc.append([5, n + 9, n - 3])
            else:
                if i < self.fg // 2:
        ...
        if i < self.fg - 1 and self.fg > 1:
            fc.append([n - 7, n - 8, n + 4, n + 5])
            fc.append([n - 8, n - 9, n + 3, n + 4])
            fc.append([n - 9, n - 3, n + 9, n + 3])
            fc.append([n - 10, n - 11, n + 1, n + 2])
            fc.append([n - 11, n - 12, n, n + 1])
            fc.append([n - 4, n - 10, n + 2, n + 8])
        if i == self.fg - 1:
            fc.append([0, 8, n - 11, n - 12])
            fc.append([8, 12, n - 10, n - 11])
            fc.append([12, 4, n - 4, n - 10])
            fc.append([5, 13, n - 9, n - 3])
            fc.append([13, 9, n - 8, n - 9])
            fc.append([9, 1, n - 7, n - 8])
    SM = []
    # Duz----------------
    if self.dr == False:
        fc.append([14, 10, 11, 15])
        fc.append([6, 14, 15, 7])
    # Yuvarlak-----------
    else:
        if dh > mx:
        ...
        for a in range(1, 24):
            ...
            if a == 1:
                ...
                SM.append(len(fc))
                if a < 13:
                    fc.append([n - 3, n - 1, 11])
                elif a == 13:
                    fc.append([n - 3, n - 1, 10, 11])
                else:
...
class OBJECT_OT_add_object(bpy.types.Operator):
    ...
    def execute(self, context):
        if self.son != self.prs:
            if self.prs == '1':
                Prs(self, 200, 15, 590, 44, 33, 15, 20, 30, True, 1, 2, 3, 90, 30, 30, 30, 30, 30, 30, 30, 30, 30)
            if self.prs == '2':
                Prs(self, 180, 15, 590, 44, 33, 15, 20, 30, True, 1, 2, 3, 90, 30, 30, 30, 30, 30, 30, 30, 30, 30)
            if self.prs == '3':
                Prs(self, 160, 15, 590, 44, 33, 15, 20, 30, True, 1, 2, 3, 90, 30, 30, 30, 30, 30, 30, 30, 30, 30)
            self.son = self.prs
