...
def landscape_gen(x, y, z, meshsize_x, meshsize_y,
    ...
    if ntype == 0:
        ...
        value = marble_noise(x * 2.0 / meshsize_x, y * 2.0 / meshsize_y, z * 2.0 * 2 / (meshsize_x + meshsize_y), origin, nsize, marbleshape, marblebias, marblesharpnes, distortion, depth, hardnoise, nbasis)
    elif ntype == 8:
