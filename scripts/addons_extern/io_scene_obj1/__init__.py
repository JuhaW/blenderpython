...
class ImportObjCollection(bpy.types.PropertyGroup):
    name = StringProperty(
        name = "File Path",
...
bpy.utils.register_class(ImportObjCollection)
...
class ImportOBJ(bpy.types.Operator, ImportHelper, IOOBJOrientationHelper):
    ...
    files = bpy.props.CollectionProperty(type = ImportObjCollection)
