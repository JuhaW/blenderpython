__status__ = "Yadoob scripts: Tout sélectionner"
__author__ = "Yadoob"
__version__ = "1.0"
__date__ = "2016"
...
class View3D_Origin_Modal_Operator(bpy.types.Operator):
    """set origin with right click to bounding boxes"""
    bl_idname = "object.origin_modal"
    bl_label = "Origin Modal Operator"
