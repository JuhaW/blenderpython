...
def return_panel(scene, panel):
    ...
    if panel == 'VIEW_3D': return [scene.scriptshortcuts.VIEW_3Dedit, scene.scriptshortcuts.VIEW_3D]
    if panel == 'GRAPH_EDITOR': return [scene.scriptshortcuts.GRAPH_EDITORedit, scene.scriptshortcuts.GRAPH_EDITOR]
    if panel == 'NLA_EDITOR': return [scene.scriptshortcuts.NLA_EDITORedit, scene.scriptshortcuts.NLA_EDITOR]
    if panel == 'IMAGE_EDITOR': return [scene.scriptshortcuts.IMAGE_EDITORedit, scene.scriptshortcuts.IMAGE_EDITOR]
    if panel == 'SEQUENCE_EDITOR': return [scene.scriptshortcuts.SEQUENCE_EDITORedit, scene.scriptshortcuts.SEQUENCE_EDITOR]
    if panel == 'CLIP_EDITOR': return [scene.scriptshortcuts.CLIP_EDITORedit, scene.scriptshortcuts.CLIP_EDITOR]
    if panel == 'TEXT_EDITOR': return [scene.scriptshortcuts.TEXT_EDITORedit, scene.scriptshortcuts.TEXT_EDITOR]
    if panel == 'NODE_EDITOR': return [scene.scriptshortcuts.NODE_EDITORedit, scene.scriptshortcuts.NODE_EDITOR]
    if panel == 'LOGIC_EDITOR': return [scene.scriptshortcuts.LOGIC_EDITORedit, scene.scriptshortcuts.LOGIC_EDITOR]
