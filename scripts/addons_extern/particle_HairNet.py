...
#     seamEdges = sortEdges(seamEdges)
    ...
    if debug:
        debPrintSeams(seamVerts, seamEdges)
            ...
            if thisVert not in triedVerts:
                ...
                if len(all_edges) == 1:
                    ...
                    while walking:
                        ...
                        if thatVert not in triedVerts:
                            triedVerts.append(thatVert)
    ...
    for thisVert in startingVerts:
        ...
        while keepRunning:
            ...
            try:
                ...
                keepRunning = False
            if debug:
                print("next vert is in edge", thisEdge.key)
...
#                     options[2] = self.headObj.particle_systems[sysName]
    ...
    def createHair(self, ob, guides, options):
        ...
        if debug:
            print("Active Object: ", bpy.context.scene.objects.active.name)
