...
class SeparaConectaOperator(bpy.types.Operator):
    "separa o une las caras de la malla "
    bl_idname = 'mesh.separa_conecta_caras'
...
class SeparaConectaOperatorPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row.operator(SeparaConectaOperator.bl_idname)
