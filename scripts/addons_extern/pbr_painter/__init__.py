...
# NOTE: Node material is simplified version of PBR nodes by BlackhartFilms
# http://blackhartfilms.weebly.com/art-gallery.html

# TODO: make points more dense based on brush size
# TODO: merge undo
# TODO: reset paint bool on scene load
# TODO: setup enables paint bool
# TODO: show hint that draw brush needs to be selected
# TODO: id map/vcols map
...
# Do not forget to save all texture slots on exit
