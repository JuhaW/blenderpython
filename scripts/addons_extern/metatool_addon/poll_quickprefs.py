...
def gllightpreset_name(self, context):
    ...
    tmp = self.name
    if renaming == True:
        gllightpreset_rename(lastname, tmp)
    # gllightpreset_sort()
...
class SubLoc_Quickpref():
    ...
    def poll(cls, context):
        return context.scene.osc_quickpref

# Sub Panel


class PANEL(SubLoc_Quickpref, bpy.types.Panel):
    """Quick Preferences"""
    bl_idname = "quick_preferences"
    bl_label = "[QUICK PREFERNCES]"
