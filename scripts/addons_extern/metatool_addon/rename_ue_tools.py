...
class TestButton(bpy.types.Operator):
    """Button for tests"""
    bl_idname = "rename.initbutton"
    bl_label = "Advance Rename"
...
class Mainpanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.separator()      
        col.operator ("rename.initbutton", text= "Advance Rename", icon='SORTALPHA')
