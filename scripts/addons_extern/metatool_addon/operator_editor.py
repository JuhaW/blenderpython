...
bl_info = {
    "name": "Display Windows Menu",
    "author": "Cedric_Lepiller & DoubleZ & Lapineige & mkbreuer",
    "version": (0, 1, 0),
    "blender": (2, 7, 1),
    "location": "3D View",
    "description": "[ALT+\] Window Views Menu, View menu to show area, split and join",
...
class ViewExtendMenu(bpy.types.Menu):
    bl_label = "Window Views Menu [ALT+\]"
    bl_idname = "htk_ViewExtendMenu"
    ...
    def draw(self, context):
        ...
        layout.menu("View_Custom_Menu", text="Editor View", icon="PLUG")
...
if __name__ == "__main__":
    ...
    bpy.ops.wm.call_menu(name=ViewExtendMenu.bl_idname)
