...
class SubLoc_Arewo():
    ...
    def poll(cls, context):
        return context.scene.osc_arewo and context.mode == ('OBJECT')


# Sub Panel
class META_TAB_Arewo(SubLoc_Arewo, bpy.types.Panel):
    """Arewo - Animation Offset"""
...
def register():
    # bpy.utils.register_class(META_TAB_Arewo)
...
def unregister():
    # bpy.utils.unregister_class(META_TAB_Arewo)
