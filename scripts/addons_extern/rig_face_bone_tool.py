        ...
        for r in rec:
            ...
            if n > 0:
                ...
                if __section == '[Common]':
                    l = t.partition('=')
                    if l[0] == 'Version':
                        __mtrk.common[0].version = l[2]
                    elif l[0] == 'Name':
                        __mtrk.common[0].name = l[2]
                    elif l[0] == 'Color':
                        c = l[2].split(',')
                        __mtrk.common[0].color = [int(c[0]), int(c[1]), int(c[2])]
                    elif l[0] == 'DynamicsMode':
                        __mtrk.common[0].dynamicsmode = int(l[2])
                    elif l[0] == 'PlayMode':
                        __mtrk.common[0].playmode = int(l[2])
                elif __section == '[Master]':
                    l = t.partition('=')
                    if l[0] == 'PreMeasure':
                        __mtrk.master[0].premesure = int(l[2])
                elif __section == '[Mixer]':
                    l = t.partition('=')
                    if l[0] == 'MasterFeder':
                        __mtrk.mixer[0].masterfeder = int(l[2])
                    elif l[0] == 'MasterPanpot':
                        __mtrk.mixer[0].masterpanpot = int(l[2])
                    elif l[0] == 'MasterMute':
                        __mtrk.mixer[0].mastermute = int(l[2])
                    elif l[0] == 'OutputMode':
                        __mtrk.mixer[0].outputmode = int(l[2])
                    elif l[0] == 'Tracks':
                        ...
                        if n.isdigit():
                            ...
                            if l[0].find('Feder') >= 0:
                                trk.feder = int(l[2])
                            elif l[0].find('Panpot') >= 0:
                                trk.panpot = int(l[2])
                            elif l[0].find('Mute') >= 0:
                                trk.mute = int(l[2])
                            elif l[0].find('Solo') >= 0:
                                trk.solo = int(l[2])
                    ...
                    for e in __mtrk.eventlist:
                        if '[' + e.id + ']' == __section:
                            ...
                            if l[0] == 'Type':
                                ...
                                e.rec.length = int(l[2])
                            elif l[0] == 'Note#':
                                e.rec.note = int(l[2])
                            elif l[0] == 'Dynamics':
                                e.rec.dynamics = int(l[2])
                            elif l[0] == 'PMBendDepth':
                                e.rec.pmbenddepth = int(l[2])
                            elif l[0] == 'PMBendLength':
                                e.rec.pmbendlength = int(l[2])
                            elif l[0] == 'PMbPortamentoUse':
                                e.rec.pmbportamentouse = int(l[2])
                            elif l[0] == 'DEMdecGainRate':
                                e.rec.demdecgainrate = int(l[2])
                            elif l[0] == 'DEMaccent':
                                e.rec.demaccent = int(l[2])
                            elif l[0] == 'IconHandle':
                            ...
                            elif l[0] == 'VibratoDelay':
                                e.rec.vibratodelay = int(l[2])
                        ...
                        if l[1] == '=':
                            ...
                            if ty == 1:
                                ...
                                if l[0] == 'IconID':
                                    ...
                                    h.startdepth = int(l[2])
                                elif l[0] == 'DepthBPNum':
                                    h.depthbpnum = int(l[2])
                                elif l[0] == 'StartRate':
                                    h.startrate = int(l[2])
                                elif l[0] == 'RateBPNum':
                                    h.ratebpnum = int(l[2])
