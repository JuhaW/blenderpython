...
class YMirrorOperator(bpy.types.Operator):
    '''Applies an Y-axis mirror modifier to the selected object. If more objects are selected, they will be mirrored around the active object.'''
    bl_idname = "boolean.mod_ymirror"
    bl_label = "Y-Mirror"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def execute(self, context):
        ...
        if len(bpy.context.selected_objects)==1 :
            ...
            md = activeObj.modifiers.new('ymirror', 'MIRROR')
