...
class GPENCIL_SURFSK_add_surface(bpy.types.Operator):
...
class GPENCIL_SURFSK_edit_strokes(bpy.types.Operator):
...
class CURVE_SURFSK_reorder_splines(bpy.types.Operator):
...
def register():
    bpy.utils.register_class(GPENCIL_SURFSK_add_surface)
    bpy.utils.register_class(GPENCIL_SURFSK_edit_strokes)
    bpy.utils.register_class(CURVE_SURFSK_reorder_splines)
...
def unregister():
    bpy.utils.unregister_class(GPENCIL_SURFSK_add_surface)
    bpy.utils.unregister_class(GPENCIL_SURFSK_edit_strokes)
    bpy.utils.unregister_class(CURVE_SURFSK_reorder_splines)
