...
class materialPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row(1)
        row.operator("scene.to_all", text="Copy to selected").mode = "material, selected"
        row.operator("scene.to_all", text="Copy to children").mode = "material, children"
        
        row = layout.row(1)
        row.operator("scene.to_all", text="Append to selected").mode = "material, selected, append"
        row.operator("scene.to_all", text="Append to children").mode = "material, children, append"
...
class modifierPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row(1)
        row.operator("scene.to_all", text="Copy to selected").mode = "modifier, selected"
        row.operator("scene.to_all", text="Copy to children").mode = "modifier, children"
        
        row = layout.row(1)
        row.operator("scene.to_all", text="Append to selected").mode = "modifier, selected, append"
        row.operator("scene.to_all", text="Append to children").mode = "modifier, children, append"
