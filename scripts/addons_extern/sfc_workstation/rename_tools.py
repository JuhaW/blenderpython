...
def rename_draw(self,context):
    layout = self.layout
    col = layout.column(align=True)
    col.operator("object.copynametodata", "", icon="PASTEDOWN") 
...
def register():
    ...
    bpy.types.OUTLINER_HT_header.prepend(rename_draw)
...
def unregister():
    ...
    bpy.types.OUTLINER_HT_header.remove(rename_draw)
